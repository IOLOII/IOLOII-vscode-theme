...
# update
* :star::star: 配套使用拓展sync: 配置Gist ID:f7274e9f2d2f1ae2f0c10e76dbe1887a。请复制这个 ID 并将其用于其他设备来下载配置。
...
# update
* :star::star: Supporting the use of extended sync: Configure Gist ID: f7274e9f2d2f1ae2f0c10e76dbe1887a. Please copy this ID and use it for other devices to download the configuration.
